...
def _background_step2(lead_id, task_id, data, n8n_url):
    try:
        send_to_lobees(lead_id, task_id, 2, data)
    except Exception as e:
        print(f"Error send_to_lobees paso 2: {e}")
    try:
        add_task_log(task_id, "Formulario paso 2 enviado: Horario confirmado", percent=66)
    except Exception as e:
        print(f"Error add_task_log paso 2: {e}")
    if n8n_url:
        ...
        try:
            ...
            print(f"n8n notificado paso 2: {n8n_url_real}")
        except Exception as e:
            print(f"Error n8n paso 2: {e}")
